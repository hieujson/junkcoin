...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hieujson/junkcoinV3>";
    const std::string URL_WEBSITE = "<https://github.com/hieujson/junkcoinV3>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // junkcoin: Do we need to do any RPC mining init here?
